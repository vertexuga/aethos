...
<task type="auto">
  ...
  <action>
    ...
    5. Extract the existing example_frontend.js into proper components:
      ...
      - src/pages/HomePage.jsx -- The HomePage component, importing MenuLink, ParticleCanvas, CustomCursor. Reproduce the exact layout, SVG decorations, gradient backgrounds, and text from example_frontend.js. The "Begin Journey" MenuLink gets an onClick that calls navigate('/game').
